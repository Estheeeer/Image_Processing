% Function RESPONSEIMG is used to find the response gradient 
% magnitude image of each segment direction. 
% ------------------------------------------------------------------
% Parameter: 
%       Input:
...
% ------------------------------------------------------------------
% Usage:
%       e.g. outMap = responseimg(img, edgeImage, kerRef, 8)
% ------------------------------------------------------------------
% Note:
...
function outMap = responseimg(img, map, kerRef, dirNum)
    ...
    for li = 1 : dirNum
        ...
        % convolute the kernel with the each pixel of gradient map
